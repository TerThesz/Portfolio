const Notes = ({ found_content, content }: any) => {
  return (
    <div className='w-full h-full mt-20 px-20 grid grid-cols-5 grid-rows-5 gap-5 dark:bg-gray-700 dark:text-white'>
      {(() => {
...
const NoteElement = ({ data }: any) => {
  return (
    <div className='w-full rounded-lg border p-6 border-gray-300 dark:border-gray-900'>
